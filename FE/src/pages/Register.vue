        ...
        >
            ...
            id="register-form">
                ...
                <div class="w-full max-w-xs">
                    <div  
                        :class="{
                            'border-red-500': inputEmailMessage,
                            'border-gray-300': !inputEmailMessage,
                        }"
                        class="relative w-full my-2 flex items-center border-1 rounded-lg border-gray-300 appearance-none">
                        <input 
                            type="text" 
                    ...
                    <p 
                        v-show="inputEmailMessage"
                        :class="{'animation-custom': inputEmailMessage }"
                        class="mt-2 text-xs text-red-600 dark:text-red-400"><span class="font-medium">Oops!</span> {{ inputEmailMessage }}.
                    </p>
                </div>
                <div class="w-full max-w-xs">
                    <div 
                ...
                <div class="w-full max-w-xs">
                    ...
                    <p 
                        v-show="inputConfirmPasswordMessage"
                        :class="{'animation-custom': inputConfirmPasswordMessage }"
                        class="mt-2 text-xs text-red-600 dark:text-red-400"><span class="font-medium">Oops!</span> {{ inputConfirmPasswordMessage }}.
                    </p>
                </div>
                <button 
                    @click="registerform()"
                    ...
                    class="text-lg w-full max-w-xs rounded-md py-2 mt-6">Đăng kí</button>
