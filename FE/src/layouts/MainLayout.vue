    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/" class="flex ms-2 md:me-24">
          <img src="/imgs/main-logo.jpg" class="h-8 me-3 rounded-full" alt="FlowBite Logo" />
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">QAH</span>
        </a>
      </div>
      <div class="flex items-center lg:flex-1">
        <!-- thanh search lg -->
          <form class="max-w-md mx-auto flex-1 lg:block hidden">   
              ...
              <div class="relative">
                  ...
                  <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Giao dịch, danh mục,..." required />
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <router-link 
              to="/" 
              :class="{
                'bg-sky-300 dark:bg-sky-700 text-gray-900 dark:text-white': isHomePage,
                'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700': !isHomePage
              }"
         ...
         <li>
            <router-link 
              to="/transactions" 
              :class="{
                'bg-sky-300 dark:bg-sky-700 text-gray-900 dark:text-white': isTransactions,
                'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700': !isTransactions
              }"
              class="flex items-center p-2 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Giao dịch</span>
            </router-link>
         </li>
         <li>
            <router-link 
              to="/categories" 
              :class="{
                'bg-sky-300 dark:bg-sky-700 text-gray-900 dark:text-white': isCategories,
                'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700': !isCategories
              }"
              class="flex items-center p-2 group">
               <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
         ...
         <li>
            <router-link 
              to="/budgets" 
              :class="{
                'bg-sky-300 dark:bg-sky-700 text-gray-900 dark:text-white': isbudgets,
                'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700': !isbudgets
              }"
              class="flex items-center p-2 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Ngân sách</span>
            </router-link>
         </li>
         <!-- báo cáo -->
         <li>
